...
![A screenshot of an interface consisting of a facsimile with two columns of handwritten text, and a layout analysis of the facsimile. The software recognizes the two columns and the lines of text.](images/htr-layout-analysis2.png "Layout Analysis")
