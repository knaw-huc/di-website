...
![Screenshot of Loghi. The screen shows a historical document in which the software highlights various handwritten elements (such as marginalia, date, page number) on the page. (from National Archives)](images/Loghi_2.jpg "Scan of entry Battle to Chatham (from National Archives)")
